...
**PDF:** https://arxiv.org/pdf/2604.10978v1
...
| Pathway | Drivers | Effect on Concealment |
|---------|---------|----------------------|
| **Enabling** (促进隐瞒) | perceived stigma, perceived risk, policy uncertainty → fear of negative evaluation | ↑ Concealment |
| **Inhibitory** (抑制隐瞒) | AI self-efficacy, perceived fairness, social support → psychological safety | ↓ Concealment |

## Key Insight

恐惧负面评价（fear of negative evaluation）是核心中介变量——无论哪条路径，都通过它影响隐瞒意愿。
