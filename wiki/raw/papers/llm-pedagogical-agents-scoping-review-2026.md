...
| Dimension | Options |
|-----------|---------|
| Interaction approach | Reactive vs. Proactive |
| Domain scope | Domain-specific vs. General-purpose |
| Role complexity | Single-role vs. Multi-role |
| System integration | Standalone vs. Integrated |

## Emerging Trends

1. **Multi-agent systems** — simulate naturalistic learning environments
2. **Virtual student simulation** — for agent evaluation at scale
3. **Immersive technologies** — VR/AR + LLM agents
4. **Learning analytics integration**

## Research Gaps & Ethics

- Privacy of student data
- Accuracy / hallucination in educational content
- Student autonomy when AI is pervasive
